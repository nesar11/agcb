                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="kslider z-index">
                                                <h5 className="kslider--subtitle mb-25" data-animation="fadeInUp" data-delay="0.3s">The Future of Islamic Hyebrid Finance</h5>
                                                <h2 className="kslider--title mb-40" data-animation="fadeInUp" data-delay="0.5s">Digital <br/>Currency</h2>
                                                <div className="kslider--btn" data-animation="fadeInUp" data-delay="0.7s">
                                                    <Link href="/service"><a className="theme-btn">Discover more</a></Link>
                                                </div>
                                            </div>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="kslider z-index">
                                                <h5 className="kslider--subtitle mb-25" data-animation="fadeInUp" data-delay="0.3s">The Future of Islamic Hyebrid Finance</h5>
                                                <h2 className="kslider--title mb-40" data-animation="fadeInUp" data-delay="0.5s">AlaDeen <br/>Gold</h2>
                                                <div className="kslider--btn" data-animation="fadeInUp" data-delay="0.7s">
                                                    <Link href="https://play.google.com/store/apps/details?id=io.aladeen.trader"  target="_blank"><a className="theme-btn">Discover more</a></Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
